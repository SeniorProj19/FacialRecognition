...
class Camera_viewState extends APIState {
  ...
  Future loading(){
    return showDialog(context: context,
        builder: (BuildContext context){//Loading(indicator: BallPulseIndicator(), size: 100.0
      return SimpleDialog(title: Text("Loading"),//new CircularProgressIndicator(),
        children: <Widget>[
          Container(
            child: new CircularProgressIndicator( )//Text("Loading")
            ),
        ],
